    ...
    <div class="col-md-6 col-lg-4 mt-3" id=${id} key=${id}>
      <div class='card shadow-sm task__card'>
        ...
        <div class='card-header d-flex justify-content-end task__card__header'>
            <button type='button' class='btn btn-outline-primary m-2' name=${id} onclick="editTask.apply(this, arguments)">
                <i class='fas fa-pencil-alt name=${id}'></i>
            </button>
             <button type='button' class='btn btn-outline-danger m-2' name=${id} onclick="deleteTask.apply(this, arguments)">
        ...
        <div class='card-body'>
            ...
            //   `<img width='100%' src=${url} alt='Card Image' class='card-img-top md-3 rounded-lg' />`
              url
                ?`<img width='50%' src=${url} alt='Card Image' class='card-img-top md-3 rounded-lg' />`
                :`<img width='50%' src="/image.png" alt='Card Image' class='card-img-top md-3 rounded-lg' />`
            }
...
const openTask = (e) =>{
  ...
  const editTask = (e) =>{
    ...
    submitButton.getAttribute("onclick","saveEdit.apply(this,argument)");
